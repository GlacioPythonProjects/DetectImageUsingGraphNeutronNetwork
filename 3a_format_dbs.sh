...
COLUMBIA="/media/nas2/Mayer/tampering-databases/columbia_uncompressed_database/"

#path to carvalho database
#download: http://ic.unicamp.br/~rocha/pub/downloads/2014-tiago-carvalho-thesis/tifs-database.zip
CARVALHO="/media/nas2/Mayer/tampering-databases/carvalho-tifs-database/"

#path to korus database
#download: http://pkorus.pl/downloads/dataset-realistic-tampering
KORUS="/media/nas2/Mayer/tampering-databases/korus-realistic-tampering-database/"
